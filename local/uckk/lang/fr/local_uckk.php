...
$string['boundarynotice_desc'] = 'Affiche un rappel indiquant que l’UCKK est un établissement virtuel de puissance opératoire dont les reconnaissances restent internes sauf accréditation formelle explicite.';
$string['boundarynotice_short'] = 'Établissement virtuel UCKK — reconnaissance interne.';
...
$string['default_boundarynotice'] = 'L’UCKK est un établissement virtuel de puissance opératoire. Ses Niveaux, portfolios, dossiers de passage et Parchemins UCKK sont des reconnaissances internes sauf accréditation formelle explicite.';
...
$string['campus_intro'] = 'Bienvenue dans l’Univers-Cité King Klown, établissement virtuel de puissance opératoire consacré au Grand Jeu social : lire les systèmes, produire des preuves, délibérer et tenir mémoire.';
...
$string['campus_subtitle'] = 'Établissement virtuel de puissance opératoire pour comprendre, prouver, délibérer et tenir mémoire.';
...
$string['default_campusdescription'] = 'Établissement virtuel de puissance opératoire consacré au Grand Jeu social.';
...
$string['public_home_eyebrow'] = 'Établissement virtuel de puissance opératoire';
...
$string['public_home_quicklink_courses_desc'] = 'Accéder aux cours, aux ressources, aux activités et aux repères de progression disponibles.';
...
$string['public_home_orientation_title'] = 'Un établissement virtuel pour lire, agir et tenir mémoire';
$string['public_home_orientation_body'] = 'L’Univers-Cité King Klown organise la puissance opératoire comme un cycle complet : connaître, choisir, agir, documenter, corriger et transmettre.';
...
$string['public_home_orientation_item_choose'] = 'Choisir des chemins de progression reliés à des voies, des cours, des défis et des preuves.';
...
$string['public_home_notice_body'] = 'L’UCKK est un établissement virtuel de puissance opératoire. Ses Niveaux, Parchemins UCKK, portfolios, dossiers de passage et reconnaissances internes attestent une progression dans l’écosystème UCKK. Ils ne constituent pas des diplômes publics accrédités, des grades universitaires ou des titres professionnels reconnus par l’État, sauf reconnaissance officielle future.';
$string['public_home_cta_title'] = 'Explorer les cours';
$string['public_home_cta_body'] = 'Commencer par les voies, ouvrir les cours associés, puis relier les preuves de progression aux défis, aux assemblées, aux portfolios et au Registraire.';
...
$string['public_about_summary'] = 'L’UCKK est un établissement virtuel de puissance opératoire consacré au Grand Jeu social. Elle forme, documente, met en scène, vérifie et transmet des savoirs liés aux systèmes humains, aux technologies, aux preuves et à la gouvernance collective.';
$string['public_about_what_title'] = 'Ce qu’est l’UCKK';
$string['public_about_what_body'] = 'L’Univers-Cité King Klown est un établissement virtuel de puissance opératoire en émergence. Elle rassemble des cours, des voies, des défis, des assemblées, un Registraire, des portfolios, des preuves et des formes de reconnaissance interne. Elle sert à former des personnes capables de comprendre les systèmes dans lesquels elles vivent, d’agir avec lucidité, de documenter leurs preuves de progression et de participer à des décisions collectives.';
$string['public_about_campus_title'] = 'Ce que montre l’espace public';
...
$string['public_about_card_uckk_body'] = 'La branche éducative : voies, niveaux, Parchemins, défis, preuves, assemblées et puissance opératoire.';
...
$string['public_about_notice_body'] = 'Les informations publiques doivent rester claires sur le statut de l’UCKK : les reconnaissances sont internes à l’Univers-Cité King Klown et ne remplacent pas des diplômes publics accrédités.';
