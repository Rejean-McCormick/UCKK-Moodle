...
$string['uckkcampus'] = 'Cité d’apprentissage UCKK';
...
$string['boundarynotice_desc'] = 'Affiche un rappel indiquant que l’UCKK est une cité d’apprentissage public émergente dont les reconnaissances restent internes sauf accréditation formelle explicite.';
$string['boundarynotice_short'] = 'Campus pédagogique UCKK — reconnaissance interne.';
...
$string['default_boundarynotice'] = 'L’UCKK est une cité d’apprentissage public émergente. Ses Niveaux, portfolios, dossiers de passage et Parchemins UCKK sont des reconnaissances internes sauf accréditation formelle explicite.';
...
$string['campus_intro'] = 'Bienvenue dans l’Univers-Cité King Klown, cité d’apprentissage pour lire les systèmes, produire des preuves, délibérer et tenir mémoire.';
$string['campus_pathways_desc'] = 'Explorer les parcours, exigences, cours, Parchemins UCKK et compétences associés.';
$string['campus_pathways_title'] = 'Parcours UCKK';
$string['campus_programs_desc'] = 'Consulter les voies, blocs de formation, cours associés et repères de progression.';
$string['campus_programs_title'] = 'Voies UCKK';
$string['campus_recognition_notice'] = 'Les parcours, Parchemins UCKK et reconnaissances UCKK sont internes sauf accréditation formelle explicite.';
...
$string['campus_seed_desc'] = 'Installer ou vérifier les catégories, cours, rôles, parcours, Parchemins UCKK et presets UCKK.';
$string['campus_seed_title'] = 'Installation et presets';
$string['campus_subtitle'] = 'Cité d’apprentissage public émergente pour apprendre, prouver, délibérer et tenir mémoire.';
...
$string['default_campusdescription'] = 'Cité d’apprentissage public émergente de l’Univers-Cité King Klown.';
...
$string['dashboard_card_badges_desc'] = 'Voir les Parchemins UCKK et reconnaissances internes obtenus.';
$string['dashboard_card_badges_title'] = 'Parchemins';
...
$string['program:internalrecognition_desc'] = 'Texte indiquant la nature interne de la reconnaissance associée à la voie.';
$string['program:limitsnotice'] = 'Avis de limites';
$string['program:limitsnotice_default'] = 'Cette voie relève d’une reconnaissance interne UCKK.';
...
$string['program:requiresarchive_desc'] = 'Exige un objet inscrit au Registraire pour compléter ou reconnaître cette voie.';
...
$string['public_metadata_registry_heading'] = 'État du registre';
$string['public_metadata_nature'] = 'Nature';
$string['public_metadata_role'] = 'Rôle';
$string['public_metadata_recognition'] = 'Reconnaissance';
$string['public_metadata_public_limit'] = 'Limite publique';
$string['public_metadata_active_pathways'] = 'Voies actives publiées';
$string['public_metadata_internal_parchments'] = 'Niveaux, portfolios, dossiers de passage et Parchemins UCKK internes';
$string['public_metadata_not_accredited'] = 'Les reconnaissances UCKK ne sont pas des diplômes publics accrédités.';
$string['public_nature_value'] = 'Cité d’apprentissage public émergente';
$string['public_role_value'] = 'Branche éducative du mouvement kOA';

// Public home page.
$string['public_home_title'] = 'Univers-Cité King Klown';
$string['public_home_eyebrow'] = 'Cité d’apprentissage public émergente';
$string['public_home_subtitle'] = 'Comprendre le jeu. Jouer avec lucidité. Changer les règles.';
$string['public_home_summary'] = 'L’UCKK relie cours, voies, défis, preuves, assemblées, archives et médiathèque pour former des personnes capables de lire les systèmes, produire des traces, délibérer et agir avec méthode.';
$string['public_home_quicklink_pathways_label'] = 'Explorer les voies';
$string['public_home_quicklink_pathways_desc'] = 'Situer les grands chemins de formation, les domaines d’action et les progressions possibles.';
$string['public_home_quicklink_courses_label'] = 'Voir les cours';
$string['public_home_quicklink_courses_desc'] = 'Accéder aux espaces d’apprentissage, aux ressources, aux activités et aux évaluations disponibles.';
$string['public_home_quicklink_mediatheque_label'] = 'Consulter la médiathèque';
$string['public_home_quicklink_mediatheque_desc'] = 'Parcourir les contenus publics, collections, références et traces documentées.';
$string['public_home_orientation_eyebrow'] = 'Orientation';
$string['public_home_orientation_title'] = 'Une cité d’apprentissage pour lire, agir et se souvenir';
$string['public_home_orientation_body'] = 'L’Univers-Cité King Klown organise l’apprentissage comme un cycle complet : connaître, choisir, agir, documenter, corriger et transmettre.';
...
$string['public_home_orientation_item_choose'] = 'Choisir des chemins d’apprentissage reliés à des voies, des cours, des défis et des preuves.';
...
$string['public_home_boundary_eyebrow'] = 'Clarté institutionnelle';
$string['public_home_boundary_title'] = 'Ce que la page publique montre';
$string['public_home_boundary_body'] = 'Les pages publiques donnent une vue claire de l’UCKK : ses voies, ses cours, ses défis, ses assemblées, sa médiathèque, ses archives et ses repères d’intégrité. Elles ne remplacent pas les espaces privés, les inscriptions, les rôles, les permissions ou les dossiers internes.';
$string['public_home_cards_heading'] = 'Portes d’entrée';
$string['public_home_notice_title'] = 'Clarté institutionnelle';
$string['public_home_notice_body'] = 'L’UCKK est une cité d’apprentissage public émergente. Ses Niveaux, Parchemins UCKK, portfolios, dossiers de passage et reconnaissances internes attestent une progression dans l’écosystème UCKK. Ils ne constituent pas des diplômes publics accrédités, des grades universitaires ou des titres professionnels reconnus par l’État, sauf reconnaissance officielle future.';
$string['public_home_cta_title'] = 'Entrer dans l’apprentissage';
$string['public_home_cta_body'] = 'Commencer par les voies, ouvrir les cours associés, puis relier les apprentissages aux défis, aux assemblées, aux portfolios et aux archives.';
$string['public_home_cta_label'] = 'Explorer les cours';

// Public about page.
$string['public_about_title'] = 'À propos';
$string['public_about_eyebrow'] = 'Situer l’UCKK';
$string['public_about_subtitle'] = 'L’Univers-Cité King Klown est la branche éducative du mouvement kOA.';
$string['public_about_summary'] = 'L’UCKK est une cité d’apprentissage public émergente. Elle forme, documente, met en scène, vérifie et transmet des savoirs liés au Grand Jeu social, aux systèmes humains, aux technologies, aux preuves et à la gouvernance collective.';
$string['public_about_what_title'] = 'Ce qu’est l’UCKK';
$string['public_about_what_body'] = 'L’Univers-Cité King Klown est une institution d’apprentissage en émergence. Elle rassemble des cours, des voies, des défis, des assemblées, des archives, des portfolios, des preuves et des formes de reconnaissance interne. Elle sert à former des personnes capables de comprendre les systèmes dans lesquels elles vivent, d’agir avec lucidité, de documenter leurs apprentissages et de participer à des décisions collectives.';
$string['public_about_campus_title'] = 'Ce que fait le campus';
$string['public_about_campus_body'] = 'Le campus public donne accès aux repères institutionnels de l’UCKK : voies, cours, défis, assemblées, médiathèque, archives, règles d’intégrité et informations publiques. Les espaces internes, inscriptions, rôles, permissions, validations et dossiers privés restent gérés dans les espaces appropriés. La page publique ne remplace pas les procédures internes.';
$string['public_about_not_title'] = 'Ce que l’UCKK n’est pas';
$string['public_about_not_body'] = 'L’UCKK n’est pas une université publique accréditée par l’État. Ses Niveaux, Parchemins UCKK, portfolios, dossiers de passage et reconnaissances internes ne doivent pas être présentés comme des diplômes publics accrédités, des grades universitaires ou des titres professionnels reconnus par l’État, sauf reconnaissance officielle future.';
...
$string['public_about_card_uckk_body'] = 'La branche éducative : apprentissages, voies, niveaux, Parchemins, défis, preuves et assemblées.';
$string['public_about_card_kingklown_title'] = 'King Klown';
$string['public_about_card_kingklown_body'] = 'La figure narrative : il attire l’attention, rend les systèmes mémorables et ouvre des scènes d’apprentissage.';
...
$string['public_about_card_archives_body'] = 'La mémoire : conservation des traces, versions, preuves, corrections et apprentissages.';
$string['public_about_notice_body'] = 'Les informations publiques doivent rester claires sur le statut de l’UCKK : les reconnaissances sont internes à la cité d’apprentissage et ne remplacent pas des diplômes publics accrédités.';
$string['public_about_cta_title'] = 'Comprendre l’architecture UCKK';
$string['public_about_cta_body'] = 'Commencer par les voies, puis explorer les cours, les défis, les assemblées et la médiathèque.';
$string['public_about_cta_label'] = 'Voir les voies';

// Public programs page.
$string['public_programs_title'] = 'Voies UCKK';
$string['public_programs_eyebrow'] = 'Cartographie des voies';
$string['public_programs_subtitle'] = 'Choisir un chemin de formation, produire des preuves et avancer vers les Niveaux et Parchemins UCKK.';
$string['public_programs_summary'] = 'Les Voies UCKK structurent les apprentissages de l’Univers-Cité King Klown : tronc commun, domaines fondateurs, cours, défis, portfolios, assemblées, archives et reconnaissances internes.';
$string['public_programs_orientation_eyebrow'] = 'Orientation canonique';
$string['public_programs_orientation_title'] = 'Choisir une voie dans la cité d’apprentissage';
$string['public_programs_orientation_body'] = 'Les Voies UCKK sont des structures internes de formation, de pratique et de reconnaissance. Elles relient les cours, les compétences, les défis, les preuves, les portfolios, les Assemblées et les passages de Niveau. Une voie n’est pas seulement une liste de cours. C’est un chemin d’apprentissage qui aide à situer une personne dans un domaine d’action, à produire des traces vérifiables et à construire progressivement un dossier de passage.';
$string['public_programs_registry_eyebrow'] = 'Voies publiques';
$string['public_programs_registry_title'] = 'Tronc commun et voies actives';
$string['public_programs_registry_body'] = 'Chaque carte présente une voie ou un bloc de formation visible publiquement. Elle peut ouvrir vers les espaces de cours associés lorsque ceux-ci sont publiés. Les voies peuvent mener à des Niveaux et Parchemins UCKK internes. Ces reconnaissances attestent une progression de compétence, de pratique, de recherche ou de contribution dans la cité d’apprentissage. Elles ne constituent pas des diplômes publics accrédités.';
$string['public_programs_cards_heading'] = 'Voies actives';
$string['public_programs_action_courses'] = 'Voir les cours associés';
$string['public_programs_course_space'] = 'Espace de cours associé';
$string['public_programs_active_metadata'] = 'Voies actives publiées';
$string['public_programs_recognition_metadata'] = 'Niveaux et Parchemins UCKK internes';
$string['public_programs_limit_metadata'] = 'Les reconnaissances UCKK ne sont pas des diplômes publics accrédités.';
$string['public_programs_notice_body'] = 'Les voies décrivent des structures pédagogiques internes à l’UCKK. Elles peuvent mener à des reconnaissances internes, mais ne constituent pas des diplômes publics accrédités.';
$string['public_programs_cta_title'] = 'Passer des voies aux apprentissages';
$string['public_programs_cta_body'] = 'Ouvre les cours associés pour consulter les modules, activités, ressources, preuves attendues et repères de progression.';
$string['public_programs_cta_label'] = 'Voir les cours associés';
...
$string['mediatheque_summary'] = 'Explorer les contenus publics autorisés : médias, collections, références externes et passages documentés.';
...
$string['mediatheque_explorer_summary'] = 'Rechercher dans les contenus publics, collections accessibles, références externes et passages documentés.';
...
$string['course_explorer_public_only_notice'] = 'Seuls les cours visibles publiquement et rattachés à des voies ou espaces de cours visibles sont affichés.';
