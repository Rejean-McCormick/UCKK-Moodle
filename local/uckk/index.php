...
/**
 * UCKK campus landing page.
 *
 * This page is the main entry point for the local_uckk plugin.
 * It provides a coherent campus hub for UCKK-Moodle without performing
 * business workflow actions directly.
 *
 * It must not:
...
$url = new moodle_url('/local/uckk/index.php');
