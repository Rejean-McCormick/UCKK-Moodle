...
$string['settingsbehaviourheading'] = 'Comportement du tableau de bord';
$string['settingsbehaviourheading_desc'] = 'Configurer l’actualisation et les limites de résumé du bloc de tableau de bord UCKK.';

$string['defaultviewmode'] = 'Mode d’affichage par défaut';
$string['defaultviewmode_desc'] = 'Choisir l’accent d’affichage par défaut. Le mode automatique laisse le bloc choisir selon les capacités de l’utilisateur et le contexte.';
$string['viewmode_auto'] = 'Automatique';
$string['viewmode_player'] = 'Joueur';
$string['viewmode_mentor'] = 'Mentor';
$string['viewmode_archivist'] = 'Archiviste';
$string['viewmode_inquisitor'] = 'Inquisiteur';
$string['viewmode_manager'] = 'Gestionnaire UCKK';

$string['showpathway'] = 'Afficher la carte de parcours';
$string['showpathway_desc'] = 'Afficher le résumé du parcours UCKK actif lorsqu’il est disponible.';
$string['showtronccommun'] = 'Afficher la carte du tronc commun';
$string['showtronccommun_desc'] = 'Afficher la progression dans le tronc commun obligatoire UCKK.';
$string['showcompetencies'] = 'Afficher la carte des compétences';
$string['showcompetencies_desc'] = 'Afficher la progression des compétences UCKK lorsqu’elle est disponible.';
$string['showbadges'] = 'Afficher la carte des badges';
$string['showbadges_desc'] = 'Afficher les badges UCKK obtenus ou en progression.';
$string['showchallenges'] = 'Afficher la carte des défis';
$string['showchallenges_desc'] = 'Afficher les résumés des Défis UCKK.';
$string['showassemblies'] = 'Afficher la carte des assemblées';
$string['showassemblies_desc'] = 'Afficher les résumés de participation et de décisions des Assemblées UCKK.';
$string['showarchive'] = 'Afficher la carte des archives';
$string['showarchive_desc'] = 'Afficher les résumés d’archives, de preuves et de portfolio UCKK.';
$string['showintegrity'] = 'Afficher la carte d’intégrité';
$string['showintegrity_desc'] = 'Afficher les retours d’intégrité seulement lorsque la personne est autorisée à les voir.';
$string['showdeadlines'] = 'Afficher la carte des échéances';
$string['showdeadlines_desc'] = 'Afficher les prochaines échéances liées à UCKK.';
$string['showportfolio'] = 'Afficher la carte du portfolio';
$string['showportfolio_desc'] = 'Afficher le résumé du portfolio du Joueur lorsqu’il est disponible.';

$string['refreshinterval'] = 'Intervalle d’actualisation automatique';
$string['refreshinterval_desc'] = 'Choisir la fréquence d’actualisation possible des résumés. Ce réglage concerne seulement l’actualisation côté interface.';
$string['refreshinterval_none'] = 'Aucune actualisation automatique';
$string['refreshinterval_1min'] = 'Chaque minute';
$string['refreshinterval_5min'] = 'Toutes les 5 minutes';
$string['refreshinterval_15min'] = 'Toutes les 15 minutes';
$string['refreshinterval_30min'] = 'Toutes les 30 minutes';

$string['maxsummaryitems'] = 'Nombre maximal d’éléments de résumé';
$string['maxsummaryitems_desc'] = 'Nombre maximal d’éléments à afficher dans chaque liste de résumé du tableau de bord.';
$string['showrestrictedindicators'] = 'Afficher les indicateurs restreints lorsque permis';
