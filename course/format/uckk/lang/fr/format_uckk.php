...
$string['formatdescription'] = 'Structure pédagogique UCKK : orientation, concepts, matière canonique, atelier, preuves, délibération, livrable, évaluation et registre.';
...
$string['section_archive'] = 'Registraire';
...
$string['section_archive_desc'] = 'Mémoire du cours : preuves, décisions, versions, corrections, Kristals et traces réutilisables conservés dans le registre.';
...
$string['section_archive_short'] = 'Registraire';
...
$string['courseindex_desc'] = 'L’index UCKK aide les participants à naviguer entre orientation, concepts, preuves, délibération, livrable, évaluation et registre.';
...
$string['uckkcoursekind_archive'] = 'Registraire';
...
$string['proofrequirements_desc'] = 'Décrit les traces attendues : texte, fichier, carte, journal IA, rapport, décision, élément de registre ou autre artefact vérifiable.';
...
// Registraire.
$string['archive'] = 'Registraire';
$string['archives'] = 'Registres';
$string['archivesection'] = 'Section du registraire';
$string['archiveitem'] = 'Élément de registre';
$string['archiveitems'] = 'Éléments de registre';
$string['archiveenabled'] = 'Registraire activé';
$string['archivedisabled'] = 'Registraire désactivé';
$string['archiverequired'] = 'Registre requis';
$string['archiveoptional'] = 'Registre optionnel';
$string['archivecreated'] = 'Registre créé';
$string['archivemissing'] = 'Registre manquant';
$string['archivelinked'] = 'Registre lié';
$string['archivereusable'] = 'Registre réutilisable';
$string['archive_desc'] = 'Le registraire conserve preuves, décisions, corrections, versions, apprentissages et Kristals pédagogiques dans le registre.';
...
$string['completionrequiresarchive'] = 'Nécessite un élément de registre';
...
$string['status_archived'] = 'Conservé';
...
$string['settings_archive'] = 'Registraire';
...
$string['settings_archive_desc'] = 'Contrôle les éléments de mémoire et de registre.';
...
$string['showarchivestatus'] = 'Afficher le statut de registre';
$string['showarchivestatus_desc'] = 'Affiche si les preuves, décisions ou livrables du cours ont été conservés dans le registre.';
...
$string['sectionrequiresarchive'] = 'Cette section exige un élément de registre';
$string['sectionrequiresarchive_desc'] = 'Indique que cette section doit produire ou lier un élément de registre.';
...
$string['renderer_archivemarker'] = 'Marqueur de registre';
...
$string['template_archivedsection'] = 'Cette section est conservée dans le registre.';
...
$string['notice_archivemissing'] = 'Aucun élément de registre n’est encore lié.';
...
$string['uckk:viewarchivemarkers'] = 'Voir les marqueurs de registre UCKK';

// Help strings.
$string['help_formatpurpose'] = 'Le format UCKK organise le cours autour du cycle : connaître, choisir, agir, se souvenir.';
$string['help_proof'] = 'Une preuve est une trace vérifiable : texte, fichier, carte, décision, journal IA, artefact, observation ou élément de registre.';
$string['help_archive'] = 'Le registre conserve la mémoire du cours : preuves, décisions, versions, corrections et apprentissages.';
...
$string['help_deliverable'] = 'Le livrable final doit démontrer une compétence par un artefact utile, vérifiable et conservable en registre.';
...
$string['course_archive'] = 'Registraire';
...
$string['emphasizearchivesection'] = 'Mettre en valeur la section Registraire';
$string['emphasizearchivesection_desc'] = 'Met en évidence la section consacrée au registre, aux traces et à la mémoire du cours.';
...
$string['linktoarchiveactivity'] = 'Lier à l’activité Registraire';
$string['linktoarchiveactivity_desc'] = 'Affiche des liens vers les activités Registraire lorsque le module correspondant est disponible.';
...
$string['sectionarchivable'] = 'Section prête pour le registre';
...
$string['sectionkind_archive'] = 'Registraire';
...
$string['sectionset_archive'] = 'Jeu Registraire';
...
$string['settings_evidence'] = 'Preuves et registre';
$string['settings_evidence_desc'] = 'Réglages d’affichage liés aux preuves, au registre, à la provenance et aux livrables.';
...
$string['showarchiveindicators'] = 'Afficher les indicateurs de registre';
$string['showarchiveindicators_desc'] = 'Affiche les marqueurs indiquant les liens de registre et de mémoire du cours.';
...
$string['aria_archivestatus'] = 'Statut de registre';
...
$string['boundary_archive'] = 'Le Registraire conserve la mémoire et les preuves du parcours.';
