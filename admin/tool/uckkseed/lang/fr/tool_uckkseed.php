...
$string['enabledpresets'] = 'Préréglages activés';
$string['enabledpresets_desc'] = 'Liste des préréglages UCKK disponibles pour les opérations de génération, validation, réinitialisation ou export.';
$string['executionmode'] = 'Mode d’exécution';
$string['executionoptions'] = 'Options d’exécution';
$string['exportpreset_desc'] = 'Exporter un préréglage UCKK au format JSON canonique.';
...
$string['settings_presets'] = 'Préréglages';
$string['settings_presets_desc'] = 'Réglages liés aux fichiers et familles de préréglages UCKK.';
