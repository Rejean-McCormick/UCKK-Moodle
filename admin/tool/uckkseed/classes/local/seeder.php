...
```php
$string['confirmationrequired'] = 'Explicit confirmation is required before applying this operation.';
$string['invalidpresetcomponent'] = 'Preset {$a} has an invalid component.';
$string['invalidpresetid'] = 'Preset {$a} has an invalid preset identifier.';
$string['invalidpresetschema'] = 'Preset {$a} has an invalid schema.';
$string['presetexportcompleted'] = 'Preset export completed.';
$string['presetexported'] = 'Preset {$a} exported.';
$string['presetexportfailed'] = 'Preset export failed.';
$string['presetexportunsupported'] = 'Preset {$a} does not support export.';
$string['presetfilenotfound'] = 'Preset file {$a} was not found.';
$string['presetfilenotreadable'] = 'Preset file {$a} is not readable.';
$string['presethandlermissing'] = 'No seed handler is available for preset {$a}.';
$string['presetitemsmissing'] = 'Preset {$a} must contain an items array.';
$string['presetjsoninvalid'] = 'Preset {$a->preset} contains invalid JSON: {$a->error}';
$string['presetmethodmissing'] = 'Preset {$a->preset} does not support method {$a->method}.';
$string['presetrunning'] = 'Running preset {$a}.';
$string['presetschemainvalid'] = 'Preset {$a} schema is invalid.';
$string['presetschemavalid'] = 'Preset {$a} schema is valid.';
...
```php
$string['confirmationrequired'] = 'Une confirmation explicite est requise avant d’appliquer cette opération.';
$string['invalidpresetcomponent'] = 'Le préréglage {$a} utilise un composant invalide.';
$string['invalidpresetid'] = 'Le préréglage {$a} utilise un identifiant invalide.';
$string['invalidpresetschema'] = 'Le préréglage {$a} utilise un schéma invalide.';
$string['presetexportcompleted'] = 'Export du préréglage terminé.';
$string['presetexported'] = 'Préréglage {$a} exporté.';
$string['presetexportfailed'] = 'Échec de l’export du préréglage.';
$string['presetexportunsupported'] = 'Le préréglage {$a} ne prend pas en charge l’export.';
$string['presetfilenotfound'] = 'Le fichier de préréglage {$a} est introuvable.';
$string['presetfilenotreadable'] = 'Le fichier de préréglage {$a} n’est pas lisible.';
$string['presethandlermissing'] = 'Aucun gestionnaire de seed n’est disponible pour le préréglage {$a}.';
$string['presetitemsmissing'] = 'Le préréglage {$a} doit contenir un tableau items.';
$string['presetjsoninvalid'] = 'Le préréglage {$a->preset} contient du JSON invalide : {$a->error}';
$string['presetmethodmissing'] = 'Le préréglage {$a->preset} ne prend pas en charge la méthode {$a->method}.';
$string['presetrunning'] = 'Exécution du préréglage {$a}.';
$string['presetschemainvalid'] = 'Le schéma du préréglage {$a} est invalide.';
$string['presetschemavalid'] = 'Le schéma du préréglage {$a} est valide.';
$string['resetcompleted'] = 'Réinitialisation terminée.';
$string['resetdisabled'] = 'Les opérations de réinitialisation sont désactivées.';
$string['resetfailed'] = 'Échec de la réinitialisation.';
$string['resetstarted'] = 'Réinitialisation démarrée.';
$string['seedcompleted'] = 'Seed terminé.';
$string['seedfailed'] = 'Échec du seed.';
$string['seedstarted'] = 'Seed démarré.';
$string['seedtooldisabled'] = 'L’outil de seed UCKK est désactivé.';
$string['validationcompleted'] = 'Validation terminée.';
$string['validationfailed'] = 'Échec de la validation.';
