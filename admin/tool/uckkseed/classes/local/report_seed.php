...
```php
$string['reportseed:created'] = 'Report definition created: {$a}';
$string['reportseed:updated'] = 'Report definition updated: {$a}';
$string['reportseed:reset'] = 'Report definition reset: {$a}';
$string['reportseed:validationok'] = '{$a} report definition(s) validated.';
$string['reportseed:error_missingkey'] = 'Report definition at position {$a} is missing a key.';
$string['reportseed:error_duplicatekey'] = 'Duplicate report definition key: {$a}';
$string['reportseed:error_missingname'] = 'Report definition {$a} is missing a name.';
$string['reportseed:error_missingcomponent'] = 'Report definition {$a} is missing a component.';
$string['reportseed:error_missingcapability'] = 'Report definition {$a} is missing a capability.';
$string['reportseed:error_invalidcapability'] = 'Invalid report capability: {$a}';
$string['reportseed:error_missingsource'] = 'Report definition {$a} is missing a source.';
$string['reportseed:error_invalidenabled'] = 'Report definition {$a} has an invalid enabled value.';
$string['reportseed:warning_componentmissing'] = 'The report component is not installed: {$a}';
$string['reportseed:warning_unknownsource'] = 'Unknown report source: {$a}';

$string['reportseed:default_player_progress'] = 'Player progress';
$string['reportseed:default_player_progress_desc'] = 'Progress overview for individual UCKK players.';
$string['reportseed:default_cohort_progress'] = 'Cohort progress';
$string['reportseed:default_cohort_progress_desc'] = 'Progress overview by cohort.';
$string['reportseed:default_program_progress'] = 'Program progress';
$string['reportseed:default_program_progress_desc'] = 'Progress overview by UCKK program.';
$string['reportseed:default_competency_matrix'] = 'Competency matrix';
$string['reportseed:default_competency_matrix_desc'] = 'Competency coverage and validation overview.';
$string['reportseed:default_badge_awards'] = 'Badge awards';
$string['reportseed:default_badge_awards_desc'] = 'Badge award overview with evidence requirements.';
$string['reportseed:default_challenge_status'] = 'Challenge status';
$string['reportseed:default_challenge_status_desc'] = 'Challenge participation, review, and validation status.';
$string['reportseed:default_assembly_decisions'] = 'Assembly decisions';
$string['reportseed:default_assembly_decisions_desc'] = 'Assembly decision and contestability overview.';
$string['reportseed:default_archive_production'] = 'Archive production';
$string['reportseed:default_archive_production_desc'] = 'Archive item, proof, Kristal, and export production.';
$string['reportseed:default_integrity_cases'] = 'Integrity cases';
$string['reportseed:default_integrity_cases_desc'] = 'Integrity case volume, status, and resolution overview.';
$string['reportseed:default_seed_execution'] = 'Seed execution';
$string['reportseed:default_seed_execution_desc'] = 'Seed execution, validation, reset, and export audit overview.';
```

Add these strings to `admin/tool/uckkseed/lang/fr/tool_uckkseed.php`:

```php
$string['reportseed:created'] = 'Définition de rapport créée : {$a}';
$string['reportseed:updated'] = 'Définition de rapport mise à jour : {$a}';
$string['reportseed:reset'] = 'Définition de rapport réinitialisée : {$a}';
$string['reportseed:validationok'] = '{$a} définition(s) de rapport validée(s).';
$string['reportseed:error_missingkey'] = 'La définition de rapport à la position {$a} n’a pas de clé.';
$string['reportseed:error_duplicatekey'] = 'Clé de définition de rapport en double : {$a}';
$string['reportseed:error_missingname'] = 'La définition de rapport {$a} n’a pas de nom.';
$string['reportseed:error_missingcomponent'] = 'La définition de rapport {$a} n’a pas de composant.';
$string['reportseed:error_missingcapability'] = 'La définition de rapport {$a} n’a pas de capacité.';
$string['reportseed:error_invalidcapability'] = 'Capacité de rapport invalide : {$a}';
$string['reportseed:error_missingsource'] = 'La définition de rapport {$a} n’a pas de source.';
$string['reportseed:error_invalidenabled'] = 'La définition de rapport {$a} a une valeur enabled invalide.';
$string['reportseed:warning_componentmissing'] = 'Le composant de rapport n’est pas installé : {$a}';
$string['reportseed:warning_unknownsource'] = 'Source de rapport inconnue : {$a}';

$string['reportseed:default_player_progress'] = 'Progression des joueurs';
$string['reportseed:default_player_progress_desc'] = 'Vue de progression pour les joueurs UCKK individuels.';
$string['reportseed:default_cohort_progress'] = 'Progression des cohortes';
$string['reportseed:default_cohort_progress_desc'] = 'Vue de progression par cohorte.';
$string['reportseed:default_program_progress'] = 'Progression des programmes';
$string['reportseed:default_program_progress_desc'] = 'Vue de progression par programme UCKK.';
$string['reportseed:default_competency_matrix'] = 'Matrice de compétences';
$string['reportseed:default_competency_matrix_desc'] = 'Vue de couverture et de validation des compétences.';
$string['reportseed:default_badge_awards'] = 'Attribution des badges';
$string['reportseed:default_badge_awards_desc'] = 'Vue des badges attribués avec exigences de preuve.';
$string['reportseed:default_challenge_status'] = 'Statut des défis';
$string['reportseed:default_challenge_status_desc'] = 'Participation, revue et validation des défis.';
$string['reportseed:default_assembly_decisions'] = 'Décisions d’assemblée';
$string['reportseed:default_assembly_decisions_desc'] = 'Vue des décisions d’assemblée et de leur contestabilité.';
$string['reportseed:default_archive_production'] = 'Production d’archives';
$string['reportseed:default_archive_production_desc'] = 'Production d’éléments d’archive, preuves, Kristaux et exports.';
$string['reportseed:default_integrity_cases'] = 'Dossiers d’intégrité';
$string['reportseed:default_integrity_cases_desc'] = 'Volume, statut et résolution des dossiers d’intégrité.';
$string['reportseed:default_seed_execution'] = 'Exécution de la graine';
$string['reportseed:default_seed_execution_desc'] = 'Audit des exécutions de graine, validations, réinitialisations et exports.';
