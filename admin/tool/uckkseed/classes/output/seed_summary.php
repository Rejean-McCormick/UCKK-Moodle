...
$string['dryrunnotice'] = 'Dry-run mode is active. No Moodle data was changed.';
$string['rollbackplannotice'] = 'Rollback-plan mode is active. No Moodle data was changed.';
...
```php id="zye790"
$string['seedsummary'] = 'Résumé de l’amorçage';
...
$string['created'] = 'Créés';
$string['updated'] = 'Mis à jour';
$string['skipped'] = 'Ignorés';
$string['failed'] = 'Échoués';
$string['warnings'] = 'Avertissements';
$string['errors'] = 'Erreurs';

$string['dryrunnotice'] = 'Le mode simulation est actif. Aucune donnée Moodle n’a été modifiée.';
$string['rollbackplannotice'] = 'Le mode plan de retour arrière est actif. Aucune donnée Moodle n’a été modifiée.';

$string['action_seed'] = 'Amorcer';
...
$string['preset_course_templates'] = 'Modèles de cours';
$string['preset_challenge_templates'] = 'Modèles de défis';
$string['preset_assembly_templates'] = 'Modèles d’assemblées';
$string['preset_archive_templates'] = 'Modèles d’archives';
