...
REPLACEMENTS = [
    ...
    ("Cohorte du baccalauréat interne Intelligence artificielle gouvernable.", "Cohorte de la Voie de l’Intelligence artificielle gouvernable."),
    ...
    ("Baccalauréat UCKK — IA gouvernable", "Voie de l’Intelligence artificielle gouvernable"),
    ...
    ("Baccalauréat en Intelligence artificielle gouvernable", "Voie de l’Intelligence artificielle gouvernable"),
    ...
    ("Voie d’Écologie — Palier de Magie opérable", "Voie de l’Écologie"),
    ("Voie de l’Intelligence artificielle gouvernable — Palier de Magie opérable", "Voie de l’Intelligence artificielle gouvernable"),
    ...
    ("Baccalauréat Intelligence artificielle gouvernable", "Voie de l’Intelligence artificielle gouvernable"),
