...
class course_module_viewed extends \core\event\base {
    ...
    public static function get_name(): string {
        ...
        if ($manager->string_exists('eventchallengeviewed', 'uckkchallenge')) {
            return get_string('eventchallengeviewed', 'uckkchallenge');
        }

        return 'UCKK Challenge viewed';
    }

    public function get_description(): string {
        return "The user with id '{${this->userid}}' viewed the UCKK challenge activity with id '{${this->objectid}}' in the course module with id '{${this->contextinstanceid}}'.";
    }
