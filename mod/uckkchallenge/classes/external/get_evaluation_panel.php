...
defined('MOODLE_INTERNAL') || die();
    ...
    /**
     * Read the evaluation panel for a submission.
     *
     * @package    mod_uckkchallenge
     * @copyright  2026 Univers-Cité King Klown
     * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
     */
    class get_evaluation_panel extends external_api {
        public static function execute_parameters(): external_function_parameters {
            return new external_function_parameters([
                'cmid' => new external_value(PARAM_INT, 'Course module id.'),
                'submissionid' => new external_value(PARAM_INT, 'Optional submission id.', VALUE_DEFAULT, 0),
            ]);
        }

        public static function execute($cmid, $submissionid = 0) : array {
            ...
            $payload = $service->get_evaluation_panel($challenge, $cm, $course, $context, $GLOBALS['USER'], (int)$params['submissionid']);
