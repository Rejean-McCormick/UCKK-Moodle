...
defined('MOODLE_INTERNAL') || die();
    ...
    /**
     * Read integrity summary for a challenge.
     *
     * @package    mod_uckkchallenge
     * @copyright  2026 Univers-Cité King Klown
     * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
     */
    class get_integrity_summary extends external_api {
        public static function execute_parameters(): external_function_parameters {
            return new external_function_parameters([
                'cmid' => new external_value(PARAM_INT, 'Course module id.'),
                'caseid' => new external_value(PARAM_INT, 'Optional case id.', VALUE_DEFAULT, 0),
            ]);
        }

        public static function execute($cmid, $caseid = 0) : array {
            ...
            $payload = (array)$service->get_integrity_summary($challenge, $cm, $course, $context, $GLOBALS['USER'], (int)$params['caseid']);
