...
defined('MOODLE_INTERNAL') || die();
     ...
     */
    class submit_proof extends external_api {
        ...
        public static function execute($cmid, $submissionid = 0, $prooftype = "text", $submissionurl = "", $relationtocriteria = "", $provenancestatement = "", $sourceauthor = "", $sourcedate = 0, $visibility = "course", $aiassisted = 0, $ailog = "", $uncertaintynotes = "") : array {
            ...
            $result = (function() use ($service, $challenge, $cm, $course, $context, $params) {
                $submission = $service->save_submission($challenge, $cm, $course, $context, $GLOBALS['USER'], [
                ...
                return $service->submit_for_review($submission, $challenge, $cm, $course, $context, $GLOBALS['USER']);
            })();
