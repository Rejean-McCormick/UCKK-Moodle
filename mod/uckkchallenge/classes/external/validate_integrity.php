...
defined('MOODLE_INTERNAL') || die();
     ...
     */
    class validate_integrity extends external_api {
        public static function execute_parameters(): external_function_parameters {
            return new external_function_parameters([
                'cmid' => new external_value(PARAM_INT, 'Course module id.'),
                'caseid' => new external_value(PARAM_INT, 'Optional integrity case id.', VALUE_DEFAULT, 0),
                'summary' => new external_value(PARAM_TEXT, 'Validation summary.', VALUE_DEFAULT, ''),
                'notes' => new external_value(PARAM_RAW, 'Validation notes.', VALUE_DEFAULT, ''),
            ]);
        }

        public static function execute($cmid, $caseid = 0, $summary = "", $notes = "") : array {
            ...
            $result = $service->validate_integrity($challenge, $cm, $course, $context, $GLOBALS['USER'], [
                'caseid' => (int)$params['caseid'],
            ...
            return [
                'status' => 'ok',
                'message' => get_string('challengevalidated', 'uckkchallenge'),
                'id' => (int)($result->id),
