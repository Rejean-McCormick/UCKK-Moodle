...
```php
$string['confirmmotionsubmit'] = 'Submit motion';
$string['confirmmotionsubmitbody'] = 'Submit this motion to the Assembly workflow. Server-side permissions and rules will determine the next state.';
$string['confirmmotionwithdraw'] = 'Withdraw motion';
$string['confirmmotionwithdrawbody'] = 'Withdraw this motion from the active Assembly workflow. The action remains auditable.';
$string['motionerror'] = 'Motion error';
$string['motionmissingbody'] = 'Add the motion text before submitting.';
$string['motionmissingidentifiers'] = 'The motion cannot be saved because required identifiers are missing.';
$string['motionmissingrationale'] = 'Add a rationale before submitting the motion.';
$string['motionmissingtitle'] = 'Add a motion title before submitting.';
$string['motionrefreshed'] = 'Motion panel refreshed.';
$string['motionrefreshfailed'] = 'Unable to refresh the motion panel.';
$string['motionrefreshing'] = 'Refreshing motion panel…';
$string['motionsaved'] = 'Motion draft saved.';
$string['motionsavefailed'] = 'Unable to save the motion draft.';
$string['motionsaving'] = 'Saving motion draft…';
$string['motionsubmitted'] = 'Motion submitted.';
$string['motionsubmitfailed'] = 'Unable to submit the motion.';
$string['motionsubmitting'] = 'Submitting motion…';
$string['motionwithdrawfailed'] = 'Unable to withdraw the motion.';
$string['motionwithdrawn'] = 'Motion withdrawn.';
$string['motionwithdrawing'] = 'Withdrawing motion…';
$string['withdrawmotion'] = 'Withdraw motion';
```

Add these strings to `mod/uckkassembly/lang/fr/uckkassembly.php`:

```php
$string['confirmmotionsubmit'] = 'Soumettre la motion';
$string['confirmmotionsubmitbody'] = 'Soumettre cette motion au workflow de l’Assemblée. Les permissions et règles côté serveur détermineront l’état suivant.';
$string['confirmmotionwithdraw'] = 'Retirer la motion';
$string['confirmmotionwithdrawbody'] = 'Retirer cette motion du workflow actif de l’Assemblée. L’action demeure auditable.';
$string['motionerror'] = 'Erreur de motion';
$string['motionmissingbody'] = 'Ajoutez le texte de la motion avant de soumettre.';
$string['motionmissingidentifiers'] = 'La motion ne peut pas être enregistrée parce que des identifiants requis sont manquants.';
$string['motionmissingrationale'] = 'Ajoutez une justification avant de soumettre la motion.';
$string['motionmissingtitle'] = 'Ajoutez un titre de motion avant de soumettre.';
$string['motionrefreshed'] = 'Panneau des motions actualisé.';
$string['motionrefreshfailed'] = 'Impossible d’actualiser le panneau des motions.';
$string['motionrefreshing'] = 'Actualisation du panneau des motions…';
$string['motionsaved'] = 'Brouillon de motion enregistré.';
$string['motionsavefailed'] = 'Impossible d’enregistrer le brouillon de motion.';
$string['motionsaving'] = 'Enregistrement du brouillon de motion…';
$string['motionsubmitted'] = 'Motion soumise.';
$string['motionsubmitfailed'] = 'Impossible de soumettre la motion.';
$string['motionsubmitting'] = 'Soumission de la motion…';
$string['motionwithdrawfailed'] = 'Impossible de retirer la motion.';
$string['motionwithdrawn'] = 'Motion retirée.';
$string['motionwithdrawing'] = 'Retrait de la motion…';
$string['withdrawmotion'] = 'Retirer la motion';
