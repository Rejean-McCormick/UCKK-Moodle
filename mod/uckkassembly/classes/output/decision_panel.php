...
$string['decisionnonsovereignnotice'] = 'Assembly decisions are procedural records. Publication, integrity review, contestation, and archive status remain subject to authorised human review.';
$string['integritystate'] = 'Integrity state';
$string['minorityreport'] = 'Minority report';
$string['opencontestations'] = 'Open contestations';
$string['restrictedvisibility'] = 'Restricted visibility';

$string['decisionstatus:draft'] = 'Draft';
$string['decisionstatus:pendingreview'] = 'Pending review';
$string['decisionstatus:published'] = 'Published';
$string['decisionstatus:contested'] = 'Contested';
$string['decisionstatus:correctionrequired'] = 'Correction required';
$string['decisionstatus:invalidated'] = 'Invalidated';
$string['decisionstatus:archived'] = 'Archived';
$string['decisionstatus:closed'] = 'Closed';
...
$string['readingtype:rawcount'] = 'Raw count';
$string['readingtype:rolereading'] = 'Role reading';
$string['readingtype:minorityreading'] = 'Minority reading';
$string['readingtype:integrityreading'] = 'Integrity reading';
$string['readingtype:facilitatorsynthesis'] = 'Facilitator synthesis';

$string['contestationstatus:opened'] = 'Opened';
$string['contestationstatus:underreview'] = 'Under review';
$string['contestationstatus:correctionrequired'] = 'Correction required';
$string['contestationstatus:resolved'] = 'Resolved';
$string['contestationstatus:dismissed'] = 'Dismissed';
$string['contestationstatus:archived'] = 'Archived';

$string['decisionaction:view'] = 'View decision';
$string['decisionaction:edit'] = 'Edit decision';
$string['decisionaction:publish'] = 'Publish decision';
$string['decisionaction:contest'] = 'Contest decision';
$string['decisionaction:archive'] = 'Archive decision';
$string['decisionaction:invalidate'] = 'Invalidate decision';
$string['decisionaction:reviewintegrity'] = 'Review integrity';
