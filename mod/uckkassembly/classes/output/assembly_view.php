...
```php
$string['action:archive'] = 'Archive';
$string['action:contest'] = 'Contest';
$string['action:createamendment'] = 'Create amendment';
$string['action:createmotion'] = 'Create motion';
$string['action:publishdecision'] = 'Publish decision';
$string['action:vote'] = 'Vote';
$string['archivepolicy:full'] = 'Full archive';
$string['archivepolicy:none'] = 'No archive';
$string['archivepolicy:summary'] = 'Summary archive';
$string['assemblynonsovereignnotice'] = 'Assembly records document collective deliberation. Final publication, archive status, and integrity outcomes remain subject to authorised human review.';
$string['assemblytype:batisseurs'] = 'Bâtisseurs';
$string['assemblytype:defis'] = 'Challenges';
$string['assemblytype:grandjeu'] = 'Grand Jeu';
$string['assemblytype:inquisiteurs'] = 'Inquisiteurs';
$string['assemblytype:joueurs'] = 'Joueurs';
$string['assemblytype:savoirs'] = 'Knowledge';
$string['contests'] = 'Contests';
$string['contests:none'] = 'No contests are linked to this assembly.';
$string['decisions'] = 'Decisions';
$string['decisions:none'] = 'No decisions have been published yet.';
$string['decisionstatus:adopted'] = 'Adopted';
$string['decisionstatus:archived'] = 'Archived';
$string['decisionstatus:contested'] = 'Contested';
$string['decisionstatus:proposed'] = 'Proposed';
$string['decisionstatus:rejected'] = 'Rejected';
$string['minutes'] = 'Minutes';
$string['minutes:none'] = 'No minutes have been published yet.';
$string['motions'] = 'Motions';
$string['motions:none'] = 'No motions have been proposed yet.';
$string['motionstatus:active'] = 'Active';
$string['motionstatus:adopted'] = 'Adopted';
$string['motionstatus:closed'] = 'Closed';
$string['motionstatus:contested'] = 'Contested';
$string['motionstatus:draft'] = 'Draft';
$string['motionstatus:pendingreview'] = 'Pending review';
$string['motionstatus:rejected'] = 'Rejected';
...
$string['votingmethod:qualifiedmajority'] = 'Qualified majority';
$string['votingmethod:simplemajority'] = 'Simple majority';
