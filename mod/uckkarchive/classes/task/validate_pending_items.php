...
Add this task to `mod/uckkarchive/db/tasks.php`:
...
$string['task:validation_ready_reason'] = 'System readiness checks passed. Item routed to human archive review.';
$string['task:validation_correction_reason'] = 'System readiness checks found missing or invalid archive metadata. Correction is required before human validation.';
```
...
$string['task:validation_ready_reason'] = 'Les vérifications système de préparation sont réussies. L’élément est orienté vers la revue humaine d’archive.';
$string['task:validation_correction_reason'] = 'Les vérifications système ont trouvé des métadonnées d’archive manquantes ou invalides. Une correction est requise avant la validation humaine.';
