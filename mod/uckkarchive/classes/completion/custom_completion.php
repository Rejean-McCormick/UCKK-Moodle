...
```php id="0po1gu"
$string['completionitemadded'] = 'Require an archive item';
$string['completionitemadded_help'] = 'The activity is complete when the user has created at least one archive item in this archive.';
$string['completionitemadded_desc'] = 'Create at least one archive item.';

$string['completionitemvalidated'] = 'Require a validated archive item';
$string['completionitemvalidated_help'] = 'The activity is complete when the user has at least one archive item that has been human reviewed, verified, validated, published, or archived.';
$string['completionitemvalidated_desc'] = 'Have at least one archive item validated.';

$string['completionkristalcreated'] = 'Require a Kristal';
$string['completionkristalcreated_help'] = 'The activity is complete when the user has created at least one Kristal in this archive.';
$string['completionkristalcreated_desc'] = 'Create at least one Kristal.';

$string['completionarchivevalidated'] = 'Require validated archive content';
$string['completionarchivevalidated_help'] = 'The activity is complete when this archive contains at least one validated, published, or archived item.';
$string['completionarchivevalidated_desc'] = 'Archive contains validated content.';

$string['completionarchiveexported'] = 'Require archive export';
$string['completionarchiveexported_help'] = 'The activity is complete when an export package has been generated for this archive.';
$string['completionarchiveexported_desc'] = 'Archive has been exported.';

$string['completionarchivestate'] = 'Require archived state';
$string['completionarchivestate_help'] = 'The activity is complete when the archive activity itself is marked archived.';
$string['completionarchivestate_desc'] = 'Archive activity is archived.';
```

Add these strings to `mod/uckkarchive/lang/fr/uckkarchive.php`:

```php id="qz355p"
$string['completionitemadded'] = 'Exiger un élément d’archive';
$string['completionitemadded_help'] = 'L’activité est terminée lorsque l’utilisateur a créé au moins un élément dans cette archive.';
$string['completionitemadded_desc'] = 'Créer au moins un élément d’archive.';

$string['completionitemvalidated'] = 'Exiger un élément d’archive validé';
$string['completionitemvalidated_help'] = 'L’activité est terminée lorsque l’utilisateur possède au moins un élément d’archive revu humainement, vérifié, validé, publié ou archivé.';
$string['completionitemvalidated_desc'] = 'Avoir au moins un élément d’archive validé.';

$string['completionkristalcreated'] = 'Exiger un Kristal';
$string['completionkristalcreated_help'] = 'L’activité est terminée lorsque l’utilisateur a créé au moins un Kristal dans cette archive.';
$string['completionkristalcreated_desc'] = 'Créer au moins un Kristal.';

$string['completionarchivevalidated'] = 'Exiger du contenu d’archive validé';
$string['completionarchivevalidated_help'] = 'L’activité est terminée lorsque cette archive contient au moins un élément validé, publié ou archivé.';
$string['completionarchivevalidated_desc'] = 'L’archive contient du contenu validé.';

$string['completionarchiveexported'] = 'Exiger une exportation d’archive';
$string['completionarchiveexported_help'] = 'L’activité est terminée lorsqu’un paquet d’exportation a été généré pour cette archive.';
$string['completionarchiveexported_desc'] = 'L’archive a été exportée.';

$string['completionarchivestate'] = 'Exiger l’état archivé';
$string['completionarchivestate_help'] = 'L’activité est terminée lorsque l’activité d’archive elle-même est marquée comme archivée.';
$string['completionarchivestate_desc'] = 'L’activité d’archive est archivée.';
