...
Add these strings to `mod/uckkarchive/lang/en/uckkarchive.php` when you generate/update the language file:

```php id="c86rxc"
$string['archivegovernancenotice'] = 'Archive records are institutional memory. Validation, revision, export, restricted visibility, and integrity-sensitive access require authorised human review.';
$string['archiveitems'] = 'Archive items';
$string['archiveitems:none'] = 'No archive items are available.';
$string['archiveview'] = 'Archive view';
$string['exports:none'] = 'No archive exports are available.';
$string['kristals'] = 'Kristals';
$string['kristals:none'] = 'No Kristals are available.';
$string['proofs'] = 'Proofs';
$string['proofs:none'] = 'No proof records are available.';
$string['validationstate'] = 'Validation state';

$string['action:additem'] = 'Add item';
$string['action:export'] = 'Export archive';
$string['action:validate'] = 'Validate items';
...
$string['kristaltype:formula'] = 'Formula';
$string['kristaltype:method'] = 'Method';
$string['kristaltype:decision'] = 'Decision';
$string['kristaltype:lesson'] = 'Lesson';
$string['kristaltype:question'] = 'Question';
$string['kristaltype:map'] = 'Map';
$string['kristaltype:reference'] = 'Reference';
$string['kristaltype:glossary_entry'] = 'Glossary entry';
$string['kristaltype:proof_pattern'] = 'Proof pattern';
$string['kristaltype:portfolio_insight'] = 'Portfolio insight';
...
$string['exporttype:package'] = 'Package';
$string['exporttype:json'] = 'JSON';
$string['exporttype:csv'] = 'CSV';
$string['exporttype:pdf'] = 'PDF';
$string['exporttype:portfolio'] = 'Portfolio';
```

Add these strings to `mod/uckkarchive/lang/fr/uckkarchive.php`:

```php id="r6sexw"
$string['archivegovernancenotice'] = 'Les traces d’archive sont une mémoire institutionnelle. La validation, la révision, l’export, la visibilité restreinte et l’accès sensible à l’intégrité exigent une revue humaine autorisée.';
$string['archiveitems'] = 'Éléments d’archive';
$string['archiveitems:none'] = 'Aucun élément d’archive n’est disponible.';
$string['archiveview'] = 'Vue de l’archive';
$string['exports:none'] = 'Aucun export d’archive n’est disponible.';
$string['kristals'] = 'Kristaux';
$string['kristals:none'] = 'Aucun Kristal n’est disponible.';
$string['proofs'] = 'Preuves';
$string['proofs:none'] = 'Aucune preuve n’est disponible.';
$string['validationstate'] = 'État de validation';

$string['action:additem'] = 'Ajouter un élément';
$string['action:export'] = 'Exporter l’archive';
$string['action:validate'] = 'Valider les éléments';
...
$string['kristaltype:concept'] = 'Concept';
$string['kristaltype:formula'] = 'Formule';
$string['kristaltype:method'] = 'Méthode';
$string['kristaltype:decision'] = 'Décision';
$string['kristaltype:lesson'] = 'Leçon';
$string['kristaltype:question'] = 'Question';
$string['kristaltype:map'] = 'Carte';
$string['kristaltype:reference'] = 'Référence';
$string['kristaltype:glossary_entry'] = 'Entrée de glossaire';
$string['kristaltype:proof_pattern'] = 'Patron de preuve';
$string['kristaltype:portfolio_insight'] = 'Insight de portfolio';
...
$string['exporttype:package'] = 'Paquet';
$string['exporttype:json'] = 'JSON';
$string['exporttype:csv'] = 'CSV';
$string['exporttype:pdf'] = 'PDF';
$string['exporttype:portfolio'] = 'Portfolio';
