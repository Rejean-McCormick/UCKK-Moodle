...
Add these strings to `mod/uckkarchive/lang/en/uckkarchive.php` if they are not already present:

```php id="y72zlr"
$string['action:archive'] = 'Archive';
$string['action:contest'] = 'Contest';
$string['action:export'] = 'Export';
$string['action:revise'] = 'Revise';
...
$string['notice:aiassisted'] = 'This archive item includes AI-assisted provenance. It remains non-authoritative until human validation.';
$string['notice:archiveitem'] = 'This archive item is part of UCKK institutional memory and remains contestable.';
$string['notice:restricted'] = 'This archive item has restricted visibility. Do not expose its contents outside authorised contexts.';
...
$string['versionnumber'] = 'Version {$a}';
```

Add these strings to `mod/uckkarchive/lang/fr/uckkarchive.php` if they are not already present:

```php id="e4s8j5"
$string['action:archive'] = 'Archiver';
$string['action:contest'] = 'Contester';
$string['action:export'] = 'Exporter';
$string['action:revise'] = 'Réviser';
$string['action:validate'] = 'Valider';
$string['action:view'] = 'Voir';
...
$string['notice:aiassisted'] = 'Cet élément d’archive inclut une provenance assistée par IA. Il demeure non souverain tant qu’il n’est pas validé humainement.';
$string['notice:archiveitem'] = 'Cet élément d’archive fait partie de la mémoire institutionnelle UCKK et demeure contestable.';
$string['notice:restricted'] = 'Cet élément d’archive a une visibilité restreinte. N’exposez pas son contenu hors des contextes autorisés.';
